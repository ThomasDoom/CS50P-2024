...
# i could rewrite this with helper functions inside of main() to make it nicer and more maintainable but this problem took all my patience and tears so this is all we got for now
